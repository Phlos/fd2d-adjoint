...
if strcmp(adjoint_source_component,'x')
    ...
    [adstf_x, misfit_x]=make_adjoint_sources(v_rec.x,v_obs.x,t,'velocity','cc_time_shift','_1');
    adstf_z = zeros(size(adstf_x));
    adstf_y = zeros(size(adstf_x));
elseif strcmp(adjoint_source_component,'z')
    disp 'makin'' Z -- X is zero'
    [adstf_z, misfit_z]=make_adjoint_sources(v_rec.z,v_obs.z,t,'velocity','cc_time_shift','_3');
...
if (strcmp(adstf_SH,'y') || strcmp(adstf_SH,'yes'))
    [adstf_y, misfit_y]=make_adjoint_sources(v_rec.y,v_obs.y,t,'velocity','cc_time_shift','_2');
