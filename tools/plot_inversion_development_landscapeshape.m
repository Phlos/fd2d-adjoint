function fig_inv2 = plot_inversion_development_landscapeshape(InvProps)
...
subplot(3,1,1)
h = semilogy(iters,misfit(2:InvProps.niter), '-k', iters,misfitseis(2:InvProps.niter), '-r', iters, misfitgrav(2:InvProps.niter), '-b');
set(h(1), 'LineWidth', 2)
set(h(2), 'LineWidth', 1)
set(h(3), 'LineWidth',1)
...
h2 = semilogy(stepcumsum,misfit(2:InvProps.niter), 'k-x', ...
    stepcumsum,misfitseis(2:InvProps.niter), 'r-x', stepcumsum, misfitgrav(2:InvProps.niter), '-bx');
