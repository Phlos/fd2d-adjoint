...
project_name='Wave_propagation.S-past-rho2-block';
...
tmax = 400;    % length of run [s] -- 1200 should be enough for ScS (=935 s) (PcP = 510)
...
movie_label = 'Block \rho_2 anomaly (v_s & v_p constant)';
